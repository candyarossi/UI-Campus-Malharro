...
<br>
    ...
    <div class="uk-width-1-4@m">
        ...
        <a href="siad-cursadas.php" class="uk-button uk-button-default uk-width-1-1 uk-margin-xsmall-bottom" style="background-color: darkorange; color: white;">Cierre de Cursadas</a>
...
<h3 class="uk-h3 uk-margin-medium">Cierre de Cursadas</h3>
