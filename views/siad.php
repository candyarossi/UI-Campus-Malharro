...
<br>
    ...
    <div class="uk-width-1-4@m">
        ...
        <a href="siad.php" class="uk-button uk-button-default uk-width-1-1 uk-margin-xsmall-bottom" style="background-color: darkorange; color: white;">Notas de Parciales</a>
...
<h4>Taller de Diseño I - 1°A - 2020</h4>
    ...
    <thead>
        <tr>
            ...
            <th class="uk-text-center uk-card-campus-secondary" colspan="2" style="border: 1px solid #A04000; color: white">1° Parcial</th>
            <th class="uk-text-center uk-card-campus-secondary" colspan="2" style="border: 1px solid #A04000; color: white">2° Parcial</th>
            <th class="uk-text-center uk-card-campus-secondary" colspan="2" style="border: 1px solid #A04000; color: white">1° Recuperatorio</th>
            <th class="uk-text-center uk-card-campus-secondary" colspan="2" style="border: 1px solid #A04000; color: white">2° Recuperatorio</th>
    ...
    <tbody>
        <tr>
            ...
            <td style="border: 1px solid grey; font-size: 13px; color: black">05/07/19</td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><b>8</b></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><input class="uk-input uk-text-center" style="width: 75px; height: 25px;" type="text" placeholder=""></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><input class="uk-input uk-text-center" style="width: 40px; height: 25px;" type="text" placeholder=""></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black">---</td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><b>---</b></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><input class="uk-input uk-text-center" style="width: 75px; height: 25px;" type="text" placeholder=""></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><input class="uk-input uk-text-center" style="width: 40px; height: 25px;" type="text" placeholder=""></td>
        ...
        <tr>
            ...
            <td style="border: 1px solid grey; font-size: 13px; color: black"><input class="uk-input uk-text-center" style="width: 75px; height: 25px;" type="text" placeholder=""></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black"><input class="uk-input uk-text-center" style="width: 40px; height: 25px;" type="text" placeholder=""></td>
            <td style="border: 1px solid grey; font-size: 13px; color: black">10/07/19</td>
